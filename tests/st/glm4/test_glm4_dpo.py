...
class TestGlm4DPO:
    """A test class for testing glm4 dpo"""
    ...
    def test_glm4_dpo_process(self):
        ...
        self.change_yaml(os.path.join(root_path, "model_configs", "glm_config", "process_glm4_9b.yaml"))
        ...
        os.system(f"python {root_path}/dpo_preprocess.py \
                    ...
                    --dst {sh_path}/glm.mindrecord")
        reader = FileReader(file_name=f"{sh_path}/glm.mindrecord")
        ms_len = reader.len()
        reader.close()
        ...
        assert os.path.isfile(f"{sh_path}/glm.mindrecord")
    ...
    def test_glm4_finetune(self):
        ...
        self.change_yaml(os.path.join(root_path, "model_configs", "glm_config", "finetune_glm4_9b.yaml"))
        scripts_cmd = f"{scripts_path} --config={root_path}/model_configs/glm_config/finetune_glm4_9b.yaml " + \
                      f"--run_mode=finetune " + \
                      f"--train_dataset={sh_path}/glm.mindrecord "
