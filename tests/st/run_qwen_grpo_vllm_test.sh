...
--sft_path_infer ./qwen2_5_vllm/predict_qwen2_5_7b_instruct_st.yaml \
--sft_path_ref ./qwen2_5_vllm/ref_qwen2_5_7b_instruct_st.yaml \
--sft_path_train ./qwen2_5_vllm/finetune_qwen2_5_7b_st.yaml \
--vocab_path $vocab_path \
--merges_file_path $merges_path \
