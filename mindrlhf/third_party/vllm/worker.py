...
class Worker(Worker):
    ...
    def __init__(
        ...
        model_runner_class: Type[GPUModelRunnerBase] = ModelRunner
        if model_config.runner_type == "pooling":
            model_runner_class = PoolingModelRunner
        elif self.model_config.is_encoder_decoder:
            model_runner_class = EncoderDecoderModelRunner
        self.model_runner: GPUModelRunnerBase = model_runner_class(
