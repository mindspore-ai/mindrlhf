...
class RefWorker(Worker):
    ...
    def compute_ref_log_prob(self, prompt_completion_ids_tensor,
                             attention_mask_tensor, samples, actual_sequence_length):
        ...
        ref_per_token_logps = self.ref_model(prompt_completion_ids_tensor,
                                             ...
                                             samples=samples, actual_seq_length=actual_sequence_length)
    ...
    def _load_checkpoint_safetensors(self):
        ...
        strategy_path = os.path.join(self.grpo_config.save_strategy_dir,
                                     'merge_strategy/infer_ref_merged_strategy.ckpt')
